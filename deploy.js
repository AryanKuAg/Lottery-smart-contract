...
const deploy = async () => {
    ...
    const result  =  await new web3.eth.Contract(JSON.parse(interface)).deploy({data:bytecode, arguments:['99']}).send({from: accounts[0], gas:'10000000' , gasPrice: '20000000000'});
